...
Section /o "Workbench Tasks" SecTasks
  SetOutPath $INSTDIR
  File "..\..\variants\Workbench Tasks.exe"
  CreateShortcut "$SMPROGRAMS\Workbench Tasks.lnk" "$INSTDIR\Workbench Tasks.exe"
SectionEnd

Section /o "Workbench Notes" SecNotes
  SetOutPath $INSTDIR
  File "..\..\variants\Workbench Notes.exe"
  CreateShortcut "$SMPROGRAMS\Workbench Notes.lnk" "$INSTDIR\Workbench Notes.exe"
SectionEnd

Section /o "Workbench Artifacts" SecArtifacts
  SetOutPath $INSTDIR
  File "..\..\variants\Workbench Artifacts.exe"
  CreateShortcut "$SMPROGRAMS\Workbench Artifacts.lnk" "$INSTDIR\Workbench Artifacts.exe"
SectionEnd

!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  !insertmacro MUI_DESCRIPTION_TEXT ${SecMain} "Installs the main Workbench Native app."
  !insertmacro MUI_DESCRIPTION_TEXT ${SecTasks} "Installs Tasks as its own taskbar app."
  !insertmacro MUI_DESCRIPTION_TEXT ${SecNotes} "Installs Notes as its own taskbar app."
  !insertmacro MUI_DESCRIPTION_TEXT ${SecArtifacts} "Installs Artifacts as its own taskbar app."
...
Section Uninstall
  ...
  Delete "$INSTDIR\Workbench Tasks.exe"
  Delete "$INSTDIR\Workbench Notes.exe"
  Delete "$INSTDIR\Workbench Artifacts.exe"
  ...
  ${If} $UpdateMode <> 1
    ...
    !insertmacro IsShortcutTarget "$SMPROGRAMS\Workbench Tasks.lnk" "$INSTDIR\Workbench Tasks.exe"
    Pop $0
    ${If} $0 = 1
      !insertmacro UnpinShortcut "$SMPROGRAMS\Workbench Tasks.lnk"
      Delete "$SMPROGRAMS\Workbench Tasks.lnk"
    ${EndIf}
    !insertmacro IsShortcutTarget "$SMPROGRAMS\Workbench Notes.lnk" "$INSTDIR\Workbench Notes.exe"
    Pop $0
    ${If} $0 = 1
      !insertmacro UnpinShortcut "$SMPROGRAMS\Workbench Notes.lnk"
      Delete "$SMPROGRAMS\Workbench Notes.lnk"
    ${EndIf}
    !insertmacro IsShortcutTarget "$SMPROGRAMS\Workbench Artifacts.lnk" "$INSTDIR\Workbench Artifacts.exe"
    Pop $0
    ${If} $0 = 1
      !insertmacro UnpinShortcut "$SMPROGRAMS\Workbench Artifacts.lnk"
      Delete "$SMPROGRAMS\Workbench Artifacts.lnk"
    ${EndIf}
